 ...
 * @param {Uint8Array} requirements
 * @param {Uint8Array} secret_moves
 * @returns {Uint8Array}
 */
export function prove_requirements(board, queue, requirements, secret_moves) {
    ...
    const ptr2 = passArray8ToWasm0(requirements, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray8ToWasm0(secret_moves, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.prove_requirements(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    if (ret[3]) {
